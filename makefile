...
all:
	mkdir -p $(BUILD_DIR)
	arm-none-eabi-as -g startup.s -o $(BUILD_DIR)/startup.o
	...
	arm-none-eabi-ld -g -o $(BUILD_DIR)/out.elf -T mem.ld $(BUILD_DIR)/startup.o $(BUILD_DIR)/SystemInit.o $(BUILD_DIR)/main.o $(BUILD_DIR)/uart.o $(BUILD_DIR)/dma.o $(BUILD_DIR)/button.o
